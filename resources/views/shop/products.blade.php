    ...
    <div class="container">
        <div class="flex-w flex-sb-m p-b-52">
            ...
            <div class="flex-w flex-c-m m-tb-10">
                ...
                <div class="flex-c-m stext-106 cl6 size-105 bor4 pointer hov-btn3 trans-04 m-tb-4 js-show-search {{ $term ? 'show-search' : '' }}">
            ...
            <!-- Search product -->
            <div class="dis-none panel-search w-full p-t-10 p-b-15" style="{{ $term ? 'display:block' : 'display:none' }}">
                <div class="bor8 dis-flex p-l-15">
                    <button class="size-113 flex-c-m fs-16 cl2 hov-cl1 trans-04">
                        <i class="zmdi zmdi-search"></i>
                    </button>
                    <form action="{{ url('shop/products') }}" method="GET">
                    <input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="term" placeholder="Search" value="{{ $term }}">
                    </form>
                </div>	
            </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item category-{{ $product->category->id }}">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('storage/uploads/products/' . $product->image) }}" alt="IMG-PRODUCT">
        ...
        @else
            ...
            <h1 class="text-center">
                <i class="fa fa-frown-o"></i> We couldn't find any items matching your criteria
            </h1>
            @else
            @endif
        @endif
