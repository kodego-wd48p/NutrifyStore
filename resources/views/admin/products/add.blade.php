                ...
                <div class="card-body ">
                    ...
                    <form method="POST" action="{{ url('admin/products') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea placeholder="Description" class="form-control" name="description" id="description" rows="4">{{ old('description') }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="cost" id="cost" placeholder="Cost" value="{{ old('cost') }}">
                        </div>
                        <div class="form-group">
